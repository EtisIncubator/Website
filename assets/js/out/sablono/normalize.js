...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__11189_SHARP_){
return ((p1__11189_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__11189_SHARP_ === 'string');
}),class$__$1))){
...
var G__11191 = attrs;
var G__11191__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(attrs))?cljs.core.update_in.call(null,G__11191,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$):G__11191);
return G__11191__$1;
});
/**
...
var len__5729__auto___11194 = arguments.length;
var i__5730__auto___11195 = (0);
while(true){
if((i__5730__auto___11195 < len__5729__auto___11194)){
args__5736__auto__.push((arguments[i__5730__auto___11195]));

var G__11196 = (i__5730__auto___11195 + (1));
i__5730__auto___11195 = G__11196;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__5737__auto__);
});
...
var G__11193 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
var G__11193__$1 = ((!(cljs.core.empty_QMARK_.call(null,classes__$1)))?cljs.core.assoc.call(null,G__11193,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1):G__11193);
return G__11193__$1;
});

sablono.normalize.merge_with_class.cljs$lang$maxFixedArity = (0);

sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq11192){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11192));
});
/**
...
var tag_name = cljs.core.nth.call(null,vec__11200,(0),null);
var names = cljs.core.nth.call(null,vec__11200,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__11200,tag_name,names){
return (function (p1__11197_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__11197_SHARP_));
});})(matches,vec__11200,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__11200,tag_name,names){
return (function (p1__11198_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__11198_SHARP_));
});})(matches,vec__11200,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__11201){
var vec__11204 = p__11201;
var tag = cljs.core.nth.call(null,vec__11204,(0),null);
var content = cljs.core.nthnext.call(null,vec__11204,(1));
...
var vec__11205 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__11205,(0),null);
var id = cljs.core.nth.call(null,vec__11205,(1),null);
var class$ = cljs.core.nth.call(null,vec__11205,(2),null);
